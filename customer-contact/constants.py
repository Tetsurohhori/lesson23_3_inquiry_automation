...
SEARCH_WIKIPEDIA_TOOL_NAME = "search_wikipedia_tool"
SEARCH_WIKIPEDIA_TOOL_DESCRIPTION = "一般的な知識や用語、歴史的な情報などをWikipediaで調べたい時に使う。専門用語の説明や背景情報の取得に有効"
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    - 【メンション先の選定理由】について、以下の条件に従って生成してください。
        - メンションする従業員が選ばれた理由を、従業員ごとに具体的に説明してください。
        - 「対応可能な問い合わせカテゴリ」「現在の主要業務」「過去の問い合わせ対応履歴」などを根拠として記載してください。
    ...
    （※メンションされた従業員が複数いる場合、全員分記載してください）
